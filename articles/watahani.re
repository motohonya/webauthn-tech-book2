...
といっても意味が分からないので、よくある楕円曲線のグラフを用いて解説します。
...
つまり、ある点 @<i>{P} に @<i>{O} を加算すると、x = 0 の直線を軸に、対称な点が @<i>{P'}, そのまた対象は @<i>{P} となります。
すなわち @<i>{P} + @<i>{O} = @<i>{P} となります。
...
小難しい解説をし巻いたが、あくまでここで覚えていただきたいのは、楕円曲線暗号が、公開鍵（楕円曲線上の座標）の足し算が可能であること、
